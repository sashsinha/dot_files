# Generated by Powerlevel10k configuration wizard on 2020-05-20 at 21:45 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_VI_MODE_NORMAL_BACKGROUND='yellow'
  typeset -g POWERLEVEL9K_VI_MODE_NORMAL_FOREGROUND='grey23'
  # Text and color for visual vi mode.
  typeset -g POWERLEVEL9K_VI_VISUAL_MODE_STRING=' %BVISUAL%b '
  typeset -g POWERLEVEL9K_VI_MODE_VISUAL_BACKGROUND='darkorange'
  typeset -g POWERLEVEL9K_VI_MODE_VISUAL_FOREGROUND='grey23'
  # Text and color for overtype (a.k.a. overwrite and replace) vi mode.
  typeset -g POWERLEVEL9K_VI_OVERWRITE_MODE_STRING=' %BREPLACE%b'
  typeset -g POWERLEVEL9K_VI_MODE_OVERWRITE_BACKGROUND='lightcyan1'
  typeset -g POWERLEVEL9K_VI_MODE_OVERWRITE_FOREGROUND='red1'
  # Text and color for insert vi mode.
  typeset -g POWERLEVEL9K_VI_INSERT_MODE_STRING=' %BINSERT%b '
  typeset -g POWERLEVEL9K_VI_MODE_INSERT_BACKGROUND='turquoise2'
  typeset -g POWERLEVEL9K_VI_MODE_INSERT_FOREGROUND='darkblue'
  ...
  typeset -g POWERLEVEL9K_HOST_BACKGROUND=1 
